...
## Bundled mappings — 2026-03-19 08:18
...
The tests in test_bundled_mappings.py were correctly named and passing, but the BDD_STATUS.md was showing them as uncovered due to a mismatch in the test naming convention used by the check_bdd_coverage.py script. This was resolved by ensuring the tests were properly named according to the scenario descriptions in BDD.md.